<?php
 ...
 class NotaRepository extends EntityRepository
 {
     ...
     public function findByUsuarioAndEtiqueta($usuario, $etiqueta)
     {
      ...
      {
         $query = $this->getEntityManager()->createQuery("SELECT n FROM JAMNotasFrontendBundle:Nota n JOIN n.usuario u  WHERE  u.username=:username ORDER BY n.fecha DESC")->setParameters(array('username' => $usuario->getUsername()));
